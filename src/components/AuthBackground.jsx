export default function AuthBackground({ children }) {
  return (
    <div className="auth-page relative isolate min-h-svh min-w-80 overflow-hidden bg-[linear-gradient(180deg,#f9fcff_0%,#f9fcff_28%,#d8ecff_100%)] font-montserrat text-[#0b2c4e] max-[760px]:overflow-y-auto [@media(max-height:850px)_and_(min-width:761px)]:overflow-y-auto">
