    ...
    <Card className="flex flex-row px-7 py-6 sm:px-14 sm:py-8 xl:px-16 rounded-xl border-white border-[3px]">
      <div className="flex-1 flex flex-col justify-center items-start gap-4">
        ...
        <button
          ...
          className="flex items-center gap-3 px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-[14px] bg-gradient-to-r from-[#113E7E] to-[#2B73C4] text-white font-medium text-sm sm:text-base shadow-md transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] cursor-pointer"
        >
          <svg
