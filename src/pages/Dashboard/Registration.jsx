...
import BnccBlueLogo from '../../assets/images/BnccBlue.png'
...
export default function Registration() {
  ...
  // Retrieve outcome status dynamically from search query parameters or default to 'initial'
  ...
  useEffect(() => {
    ...
    const mode = params.get('outcome') || 'initial'
    setOutcome(mode)
  }, [location.search])
    ...
    <Card className="w-full flex-1 flex flex-col items-center justify-center text-center p-8 sm:p-16 rounded-xl border-white border-[3px] bg-white/40 glassmorphism relative gap-6">
      ...
      <div className="mt-6 flex flex-row items-start gap-4 text-left">
        <img
          src="/icons/ic-cp.svg"
          alt="BNCC Team"
          className="h-[92px] w-auto shrink-0 object-contain self-start mt-[7px]"
        />
